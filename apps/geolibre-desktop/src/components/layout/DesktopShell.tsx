  ...
  return (
    ...
    >
      ...
      <div className="relative flex min-h-0 flex-1 flex-col md:flex-row">
        ...
        {milSymbolOpen && layoutOptions.layerPanelVisible ? (
        ...
        {analysisOpen && layoutOptions.layerPanelVisible ? (
        ...
        {sillagesOpen && layoutOptions.layerPanelVisible ? (
          <aside className="flex w-[380px] shrink-0 flex-col overflow-hidden border-l bg-card">
